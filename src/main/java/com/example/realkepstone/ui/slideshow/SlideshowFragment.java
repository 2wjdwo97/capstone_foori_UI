...
import com.example.realkepstone.ui.slideshow.SignSlideFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ganpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SignSlideFragment mfragment=new SignSlideFragment();
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentTransaction transaction=getActivity().getSupportFragmentManager().beginTransaction();
                MenuSlideFragment mfragment=new MenuSlideFragment();
                transaction.replace(R.id.Main_Frame, mfragment,"not");
                transaction.commit();
